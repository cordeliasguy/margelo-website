  ...
  <Carousel className="bg-black text-white py-10 lg:py-20">
    ...
    <CarouselItem index={5}>
      <Review by="Roland (ExtraCard)">
        We were hitting the inevitable pains of rapid growth and needed to level
        up our app quickly. What would have taken us months took the Margelo
        team mere days. There is nothing they can&apos;t figure out or make
        happen. Simply the best.
      </Review>
    </CarouselItem>
  </Carousel>
);
